...
public class RandomArraySelectorTest {
    ...
    public String[] getRandomizedArray(String[] sourceArray) {
    ...
    public static void main(String[] args) {
        ...
        String[] randomMAToZ = selector.getRandomizedArray(selector.mAToZ);
        System.out.println("Random mAToZ: " + Arrays.toString(randomMAToZ));

        // Get a randomized array from mAToAll with at least 20 elements
        String[] randomMAToAll = selector.getRandomizedArray(selector.mAToAll);
